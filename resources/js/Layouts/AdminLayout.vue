                    ...
                    <v-list-item link>
                        <v-list-item-content>
                            <v-list-item-subtitle
                                >correo@gmail.com</v-list-item-subtitle
                            >
                        </v-list-item-content>
                    </v-list-item>
                </v-list>
                    ...
                    <v-list-item-group color="primary">
                        ...
                        >
                            ...
                            <v-list-item-group color="primary">
                                ...
                                <v-list-item link>
                                    ...
                                    <v-list-item-title
                                        ><h5>MARCAS</h5></v-list-item-title
                                    >
                                </v-list-item>
                                <v-list-item link>
                                    <v-list-item-icon>
                        ...
                        >
                            <template v-slot:activator>
                                <v-list-item-content>
                                    <v-list-item-title
                                        >ADMINISTRACION</v-list-item-title
                                    >
                                </v-list-item-content>
                            </template>
                            <v-list-item-group color="primary">
                                <v-list-item link>
                                    ...
                                    <v-list-item-title>
                                        <h5>EMPRESAS</h5></v-list-item-title
                                    >
                                </v-list-item>
                                <v-list-item link>
                                    <v-list-item-icon>
