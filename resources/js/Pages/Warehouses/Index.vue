<template>
    <admin-layout>
        ...
        <v-data-table :headers="headers" :items="desserts" sort-by="name" class="elevation-24" :search="search">
            <template v-slot:top>
                <v-toolbar flat>
                    <v-toolbar-title>Lista de almacenes</v-toolbar-title>
                            ...
                            <v-card-text>
                                <v-container>
                                    <v-row>
                                        ...
                                        <v-col cols="12" sm="6" md="6">
                                            <v-text-field v-model="editedItem.contact_number"
                                        ...
                                        <v-col cols="12" sm="12" md="12">
                                            <v-textarea v-model="editedItem.description" class="mx-2" rows="2"
                                                label="Descripción">
                                            </v-textarea>
                                        </v-col>
                                    </v-row>
...
export default {
    ...
    data() {
        return {
            ...
            headers: [
                ...
                { text: 'NRO CONTACTO', value: 'contact_number'},
    ...
    computed: {
        formTitle() {
            return this.editedIndex === -1 ? 'Nueva Almacén' : 'Editar Almacén'
        },
    },
    ...
    methods: {
        ...
        deleteItemConfirm() {
            ...
            this.$inertia.delete(this.route('warehouses.destroy', this.editedItem))
            // ***************************************
        },
        ...
        save() {
            if (this.editedIndex > -1) {
                ...
                this.$inertia.patch(route('warehouses.update', this.editedItem), this.editedItem)
                // ***************************************
                ...
                // ***************************************
                // enviado formulario de almacenar 
                this.$inertia.post(route('warehouses.store'), this.editedItem)
