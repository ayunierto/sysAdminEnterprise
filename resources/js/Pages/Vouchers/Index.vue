<template>
    <admin-layout>
        ...
        class="elevation-24" :search="search">
            <template v-slot:top>
                <v-toolbar flat >
                    <v-toolbar-title>Listado de Comprobantes</v-toolbar-title>
                            ...
                            <v-container>
                                <v-row>
                                    ...
                                    <v-col cols="12" sm="12" md="12">
                                        ...
                                        filled
                                        auto-grows
                                        v-model="editedItem.description" class="mx-2"
                                        label="Descripción" 
                                        rows="6" 
                                        hint="Descripcion del comprobante" 
                                        row-height="50"
                                        counter>
                                        </v-textarea>
                                    </v-col>
...
<script>
    ...
    export default {
        ...
        computed: {
            formTitle () {
                return this.editedIndex === -1 ? 'Nueva comprobante' : 'Editar comprobante'
            },
        },
        ...
        methods: {
            ...
            deleteItemConfirm () {
                ...
                this.$inertia.delete(this.route('vouchers.destroy', this.editedItem))
                // ***************************************
            },
            ...
            save () {
                if (this.editedIndex > -1) {
                    ...
                    this.$inertia.patch(route('vouchers.update', this.editedItem ), this.editedItem)
                    // ***************************************
                    ...
                    // ***************************************
                    // enviado formulario de almacenar 
                    this.$inertia.post(route('vouchers.store'), this.editedItem)
