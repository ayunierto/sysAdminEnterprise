                ...
                <v-toolbar flat>
                    ...
                    <v-dialog v-model="dialog" max-width="500px">
                        <template v-slot:activator="{ on, attrs }">
                            ...
                            <v-card-title>
                                <v-spacer></v-spacer>
                                <v-text-field v-model="search" append-icon="mdi-magnify" label="Buscar Marca"
                                    ...
                                    <v-row>
                                        ...
                                        <v-col cols="12" sm="6" md="6">
                                            <v-text-field label="Nombre*" v-model="editedItem.name"
                                                hint="Nombre de la marca por ejemplo: cocacola, apple, xiaomi..."
                                                rerquerid>
                                            </v-text-field>
                                        </v-col>
                                        <v-col cols="12" sm="12" md="12">
                                            <v-textarea v-model="editedItem.description" class="mx-2"
                                                label="Descripción" rows="2" hint="Descripción de la marca">
                                            </v-textarea>
                                        </v-col>
                                    </v-row>
                                </v-container>
