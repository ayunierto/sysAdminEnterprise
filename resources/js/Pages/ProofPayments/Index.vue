                                    ...
                                    <v-row>
                                        <v-col cols="12" sm="6" md="6">
                                            <v-text-field label="Código*" v-model="editedItem.code"
                                                hint="Verificar códigos en Sunat..." required outlined dense>
                                            </v-text-field>
                                        </v-col>

                                        <v-col cols="12" sm="6" md="6">
                                            <v-text-field label="Nombre*" v-model="editedItem.name"
                                                hint="Verificar comprobantes segun Sunat" required outlined dense>
                                            </v-text-field>
                                        </v-col>
                                        <v-col cols="12" sm="6" md="6">
                                            <v-text-field label="Serie*" v-model="editedItem.serie"
                                                hint="Verificar series Sunat" required outlined dense>
                                            </v-text-field>
                                        </v-col>
                                    </v-row>
                                </v-container>
...
export default {
    ...
    methods: {
        initialize() {
            this.desserts = this.proofPayments
        },
        ...
        deleteItemConfirm() {
            ...
            this.$inertia.delete(this.route('proofPayments.destroy', this.editedItem))
        },
        ...
        save() {
            if (this.editedIndex > -1) {
                ...
                this.$inertia.patch(route('proofPayments.update', this.editedItem), this.editedItem)
                ...
                // ***************************************
                // enviado formulario de almacenar 
                this.$inertia.post(route('proofPayments.store'), this.editedItem)
